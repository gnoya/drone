#ifndef _ROS_darknet_ros_msgs_TrafficSignal_h
#define _ROS_darknet_ros_msgs_TrafficSignal_h
...
namespace darknet_ros_msgs
{
  ...
  class TrafficSignal : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "darknet_ros_msgs/TrafficSignal"; };
    const char * getMD5(){ return "14c4cb688c2ccc38534f4f0b57bf7e16"; };
